-- ============================================================
-- TECAMBIOYA ÔÇö Fase 2: Nodo TRUJILLO (puerto 5444)
...
-- ============================================================
-- TABLAS FRAGMENTADAS ÔÇö solo filas con region_id = 3 (Trujillo)
-- ============================================================
...
-- ============================================================
-- DATOS DE PRUEBA ÔÇö usuarios y operaciones de Trujillo
-- ============================================================
...
INSERT INTO notificaciones (usuario_id, tipo, titulo, contenido, leida)
SELECT u.id, 'orden', 'Orden en proceso', 'Tu cambio de USD 200.00 est├í siendo procesado.', FALSE
FROM usuarios u WHERE u.email = 'carmen.ruiz@gmail.com';
